...
import * as types from './resourdceVotesConstants'
...
export const updateResourceVote = (updatedInfo, id) => {
    ...
    return dispatch => {
        ...
        axios.patch(`http://localhost:8000/votes/${id}`, updatedInfo)
            .then(res => {
                dispatch({
...
export const removeResourceVote = id => {
    return dispatch => {
        ...
        axios.delete(`http://localhost:8000/votes/${id}`)
            .then(res => {
                dispatch({
